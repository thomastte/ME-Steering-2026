...
AR26.WheelBase = 1540e-3; % Car wheelbase - m
AR26.FrontTrackwidth = 1110e-3; % Front Trackwidth - m
AR26.RearTrackWidth = 1110e-3; % Rear Trackwidth - m
AR26.CGHeight = 241e-3; % Center of Gravity height - m
AR26.aLength = AR26.WheelBase*0.5541; % Distance from CoM to front axle
...
AR26.KappaMax = 1; % Maximum allowable slip ratio
AR26.KappaMin = -1; %Minimum allowable slip ratio
...
AR26.IMotor = 0.003; 
AR26.IMotorEff = AR26.IGearBox + AR26.IMotor * AR26.GearRatio^2; % Effective rotational intertia of the motor on the wheel side
