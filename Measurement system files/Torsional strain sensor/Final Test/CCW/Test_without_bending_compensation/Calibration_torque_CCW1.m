...
%Test setup with no vertical compensation
folder = 'C:\Users\maris\Documents\BACHELOR\Test\Test_Torque_sensor\Test_torque_SC2\Test_CCW1';
...
%Konverterer residualer til Nm ved bruk av valgt kalibreringssensitivitet
sensitivity_for_residuals = 28018.97; % ADC counts/Nm

residuals_Nm = residuals / sensitivity_for_residuals;
RMSE_Nm = sqrt(mean(residuals_Nm.^2));
max_residual_Nm = max(abs(residuals_Nm));
